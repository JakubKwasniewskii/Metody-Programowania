...
int main()
{
	...
	/*
	shared_ptr <Node> main = make_shared<Node>("main root");
	shared_ptr <Node> child1 = make_shared<Node>("chidl 1");
	shared_ptr <Node> child2 = make_shared<Node>("child 2");
	shared_ptr <Node> subChild = make_shared<Node>("grandchild");

	addChild(main, child1); // child1 staje sie dzieckiem main
	addChild(main, child2); // child2 staje się dzieckiem main
	addChild(child1, subChild); // subChild staje się dzieckiem child1

	printTree(main); // wyświetlanie
